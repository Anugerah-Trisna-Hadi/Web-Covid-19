                    ...
                    <?php foreach ($indonesia as $key => $value): ?>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10">
                ...
                <div class=""><h1 class="text-center color-light"><?= $value['sembuh']; ?></h1></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="event_calender table table-hover" id="hospital">
                ...
                <tbody>
                    <?php $n=1+$this->uri->segment(3); foreach ($provinsi as $key => $value): ?>
